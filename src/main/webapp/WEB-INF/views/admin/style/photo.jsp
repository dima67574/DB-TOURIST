...
<div class="col-md-12" style="margin-bottom: 15px;">
    ...
    <a href="/admin/style" class="btn btn-default" style="text-align: center">К списку стилей</a>
...
<div class="row">
    <div class='list-group gallery'>
        <c:forEach var="p" items="${style.photos}" varStatus="i">
            <c:set var="photosCount" scope="page" value="16"/>
            <c:set var="totalPages" scope="page" value="${fn:length(style.photos) / photosCount}"/>
...
<script>
    $(function () {
        ...
        document.getElementById('uploadButton').addEventListener('click', function () {
            startUpload("/admin/style/upload", ${style.id});
        }, false);
